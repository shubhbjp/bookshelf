...
window.onload = function () {
  ...
  var add_new_publication = document.getElementById('add_new_publication');

  if (add_new_publication) {
    add_new_publication.onclick = function () {
  ...
  var add_publication = document.getElementById('new_publication');

  if (add_publication) {
    add_publication.onclick = function () {
  ...
  var tab_button = document.getElementsByClassName('search_wrapper');

  if (tab_button) {
    for (var i = 0; i < tab_button.length; i++) {
      tab_button[i].onclick = function () {
        console.log(document.getElementsByClassName('book')[0].style.display);
      };
    }
  }
};
...
/******/ });
//# sourceMappingURL=application-46eb3eb226b0c003d0f8.js.map